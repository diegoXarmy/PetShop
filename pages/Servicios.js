            ...
            <div className="card mb-4 product-wap rounded-0">
              <div className="card rounded-0">
                <img
                  ...
                  src="https://wakyma.com/wakymavets/blog/wp-content/uploads/2017/07/640-1360972471815.jpg"
                />
              ...
              <div className="card-body">
                <a className="h3 text-decoration-none">Vacunas.</a>
                ...
                <p className="text-center mb-0">1.3 SOL</p>
              </div>
            </div>
          </div>
          <div className="col-md-4">
            <div className="card mb-4 product-wap rounded-0">
              <div className="card rounded-0">
                <img
                  className="card-img rounded-0 img-fluid"
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9_voKmiiNd8eqG8OmFYP1WdmdxLhu-1vO-2N3Bh2XRO43GuLOaQhHlDLC-WEOfD6dYG4&usqp=CAU"
                />
                <div className="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                  <ul className="list-unstyled">
                    <li>
              ...
              <div className="card-body">
                <a className="h3 text-decoration-none">Duchas caninas.</a>
                <ul className="w-100 list-unstyled d-flex justify-content-between mb-0">
                  <li className="pt-2"></li>
                </ul>
                <ul className="list-unstyled d-flex justify-content-center mb-1">
                ...
                <p className="text-center mb-0">1.2 SOL</p>
              </div>
            </div>
          </div>
          <div className="col-md-4">
            <div className="card mb-4 product-wap rounded-0">
              <div className="card rounded-0">
                <img
                  className="card-img rounded-0 img-fluid"
                  src="https://cdn.shopify.com/s/files/1/0575/0456/3393/files/local_interior_5_480x480.jpg?v=1628466804"
                />
                <div className="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                  <ul className="list-unstyled">
                    <li>
              ...
              <div className="card-body">
                <a className="h3 text-decoration-none">Esterilizacion.</a>
                <ul className="w-100 list-unstyled d-flex justify-content-between mb-0">
                  <li className="pt-2"></li>
                </ul>
                <ul className="list-unstyled d-flex justify-content-center mb-1">
